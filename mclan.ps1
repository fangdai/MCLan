...
function Find-Java {
    ...
    if ($best) {
        throw "Found Java $($best.Major), but this Minecraft version needs Java $MinMajor or newer. Install Temurin Java $MinMajor+ from https://adoptium.net and enable 'Set JAVA_HOME variable' and 'Add to PATH' in the installer."
    }
